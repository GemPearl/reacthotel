  ...
  if (!isLoading) 
  {
    ...
    <Search searchVal={searchInput} handler={handleSearchInput}/>
        <SearchResults results= {
            searchInput ? bookings.filter(booking => booking.firstName.toLowerCase().includes(searchInput.toLowerCase()) ||
            booking.surname.toLowerCase().includes(searchInput.toLowerCase())):bookings
                                }/>
    </div>
    );
  } 
